...
cohort = ["Roberto", "David", "Denise", "Ellie", "Muhammad", "Andrew", "Ami", "Alina", "Emily", "Alex", "Ben", "Senthooran", "Kumani", "Huda", "Carolina", "Zubayda", "Rikie", "Mohsina", "Sarah", "Lateef", "Yasien", "Jake"]

# A list of the people who have already done the daily joy challenge.
joy_bringers = ["Ben", "Rikie", "Ellie", "Kumani"]
